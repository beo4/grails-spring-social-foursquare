 ...
 */
class FoursquareReflectionUtils {

  private FoursquareReflectionUtils() {
    // static only
  }

  static getConfigProperty(String name) {
    def value = SpringSocialFoursquareUtils.config
  ...
  static void setConfigProperty(String name, value) {
    def config = SpringSocialFoursquareUtils.config
